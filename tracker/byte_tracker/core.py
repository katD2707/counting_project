...
from tracker.byte_tracker import matching
from tracker.byte_tracker.basetrack import BaseTrack, TrackState
from tracker.byte_tracker.kalman_filter import KalmanFilter
...
class ByteTracker:
    ...
    Parameters:
        track_thres (float, optional): Detection confidence threshold
            for track activation.
        track_buffer (int, optional): Number of frames to buffer when a track is lost.
        match_thres (float, optional): Threshold for matching tracks with detections.
    ...
    def __init__(
        ...
        self.track_thres = args.track_thres
        self.match_thres = args.match_thres

        self.frame_id = 0
        self.det_thresh = self.track_thres + 0.1
